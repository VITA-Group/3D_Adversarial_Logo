...
from render_model2 import RenderModel
...
class PatchTrainer(nn.Module):
    ...
    def test(self, universal_logo_cpu, mesh_paths, test_bg_data, epoch, logonum, angle_range, length):
    ...
    def attack(self):
        ...
        for epoch in range(n_epochs):
            ...
            if epoch % 3 == 0:
                ...
                # self.test(universal_logo_cpu, train_mesh_paths, test_bg_data, epoch, logonum, 30, 38)
                self.test(universal_logo_cpu, train_mesh_paths, test_bg_data, epoch, logonum, 50, 38)
...
def main():
    ...
    parser.add_argument('--patch_shape', type=str, default='G')
    # Model Configuration
